        ...
        <section className="p-4 mt-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 gap-y-2 justify-center items-center">
            {filteredPlaces.map((place, index) => (
              <article
                key={index}
                className="h-[500px] relative isolate flex flex-col justify-end overflow-hidden rounded-2xl px-8 pb-8 pt-40 max-w-sm mx-auto mt-24 bg-gray-900/40 shadow-lg hover:shadow-2xl transition duration-500 ease-in-out transform"
              >
                <img
                  src={place.image}
                  alt=""
